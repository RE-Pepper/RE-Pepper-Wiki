...
# Class al::FixMapParts



[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**FixMapParts**](classal_1_1_fix_map_parts.md)





* `#include <alFixMapParts.h>`
...
| Type | Name |
| ---: | :--- |
|   | [**FixMapParts**](#function-fixmapparts) ([**const**](classal_1_1_functor_v0_m.md) sead::SafeString & name) <br> |
...
### function FixMapParts 

```C++
al::FixMapParts::FixMapParts (
...
```C++
virtual void al::FixMapParts::appear () 
```
...
```C++
virtual void al::FixMapParts::init (
...
------------------------------
The documentation for this class was generated from the following file `/home/runner/work/RE-Pepper/RE-Pepper/lib/al/include/MapObj/alFixMapParts.h`
