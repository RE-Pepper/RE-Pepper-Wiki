...
# Class al::SwitchAreaDirector



[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**SwitchAreaDirector**](classal_1_1_switch_area_director.md)





* `#include <alSwitchAreaDirector.h>`



Inherits the following classes: [al::LiveActor](classal_1_1_live_actor.md),  [al::ISceneObj](classal_1_1_i_scene_obj.md)
...
| Type | Name |
| ---: | :--- |
|   | [**SwitchAreaDirector**](#function-switchareadirector) () <br> |
...
### function SwitchAreaDirector 

```C++
al::SwitchAreaDirector::SwitchAreaDirector () 
```
...
```C++
virtual void al::SwitchAreaDirector::movement () 
```



Implements [*al::LiveActor::movement*](classal_1_1_live_actor.md#function-movement)
...
```C++
virtual void al::SwitchAreaDirector::unk1 () 
```
