...
# File alActorPoseKeeper.cpp

[**File List**](files.md) **>** [**al**](dir_06a57bfe438b90fdc9c94a1df001d5d7.md) **>** [**src**](dir_d8628e97cbd71936d4b5fb3774410590.md) **>** [**LiveActor**](dir_8d17faa1063b24478b1232799869255d.md) **>** [**alActorPoseKeeper.cpp**](al_actor_pose_keeper_8cpp.md)

[Go to the documentation of this file](al_actor_pose_keeper_8cpp.md)
...
ActorPoseKeeperBase::ActorPoseKeeperBase() : mTrans( sead::Vector3f( 0, 0, 0 ) )
{
}
...
ActorPoseKeeperTFSV::ActorPoseKeeperTFSV()
    : ActorPoseKeeperBase(), mFront( sead::Vector3f::ez ), mScale( sead::Vector3f( 1, 1, 1 ) ),
...
ActorPoseKeeperTFGSV::ActorPoseKeeperTFGSV()
    : ActorPoseKeeperTFSV(), mGravity( sead::Vector3f( 0, -1, 0 ) )
{
}
...
ActorPoseKeeperTQSV::ActorPoseKeeperTQSV()
    : ActorPoseKeeperBase(), mQuat( sead::Quatf::unit ), mScale( sead::Vector3f( 1, 1, 1 ) ),
      mVelocity( sead::Vector3f( 0, 0, 0 ) )
{
}
...
ActorPoseKeeperTRSV::ActorPoseKeeperTRSV()
    : ActorPoseKeeperBase(), mRotate( sead::Vector3f( 0, 0, 0 ) ), mScale( sead::Vector3f( 1, 1, 1 ) ),
      mVelocity( sead::Vector3f( 0, 0, 0 ) )
{
}
...
{
        *actor->getActorPoseKeeper()->getRotatePtr() = rotate;
}
...
{
        *actor->getActorPoseKeeper()->getVelocityPtr() = velocity;
}
