...
# Class al::FallMapParts



[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**FallMapParts**](classal_1_1_fall_map_parts.md)





* `#include <alFallMapParts.h>`
...
| Type | Name |
| ---: | :--- |
|   | [**FallMapParts**](#function-fallmapparts) ([**const**](classal_1_1_functor_v0_m.md) sead::SafeString & name) <br> |
|  [**void**](classal_1_1_functor_v0_m.md) | [**exeAppear**](#function-exeappear) () <br> |
|  [**void**](classal_1_1_functor_v0_m.md) | [**exeEnd**](#function-exeend) () <br> |
|  [**void**](classal_1_1_functor_v0_m.md) | [**exeFall**](#function-exefall) () <br> |
|  [**void**](classal_1_1_functor_v0_m.md) | [**exeFallSign**](#function-exefallsign) () <br> |
...
### function FallMapParts 

```C++
al::FallMapParts::FallMapParts (
...
```C++
void al::FallMapParts::exeAppear () 
```
...
### function exeFallSign 

```C++
void al::FallMapParts::exeFallSign () 
```
...
```C++
virtual void al::FallMapParts::init (
...
```C++
virtual bool al::FallMapParts::receiveMsg (
    u32 msg,
    HitSensor * other,
    HitSensor * me
) 
...
Implements [*al::LiveActor::receiveMsg*](classal_1_1_live_actor.md#function-receivemsg)
