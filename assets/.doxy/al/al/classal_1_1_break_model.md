...
[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**BreakModel**](classal_1_1_break_model.md)





* `#include <alBreakModel.h>`
...
| Type | Name |
| ---: | :--- |
|   | [**BreakModel**](#function-breakmodel) ([**LiveActor**](classal_1_1_live_actor.md) \* parent, [**const**](classal_1_1_functor_v0_m.md) [**char**](classal_1_1_functor_v0_m.md) \* name, [**const**](classal_1_1_functor_v0_m.md) [**char**](classal_1_1_functor_v0_m.md) \* modelArchiveName, [**const**](classal_1_1_functor_v0_m.md) sead::Matrix34f \* parentBaseMtx=[**nullptr**](classal_1_1_functor_v0_m.md), [**const**](classal_1_1_functor_v0_m.md) [**char**](classal_1_1_functor_v0_m.md) \* breakActionName="Break") <br> |
| virtual [**void**](classal_1_1_functor_v0_m.md) | [**appear**](#function-appear) () <br> |
|  [**void**](classal_1_1_functor_v0_m.md) | [**exeBreak**](#function-exebreak) () <br> |
...
```C++
al::BreakModel::BreakModel (
    LiveActor * parent,
    const  char * name,
    const  char * modelArchiveName,
    const sead::Matrix34f * parentBaseMtx=nullptr,
    const  char * breakActionName="Break"
) 
```
...
```C++
virtual void al::BreakModel::appear () 
```



Implements [*al::LiveActor::appear*](classal_1_1_live_actor.md#function-appear)
...
```C++
virtual void al::BreakModel::init (
...
------------------------------
The documentation for this class was generated from the following file `/home/runner/work/RE-Pepper/RE-Pepper/lib/al/include/Npc/alBreakModel.h`
