...
[**ClassList**](annotated.md) **>** [**al**](namespaceal.md) **>** [**EffectObj**](classal_1_1_effect_obj.md)





* `#include <alEffectObj.h>`
...
| Type | Name |
| ---: | :--- |
|   | [**EffectObj**](#function-effectobj) ([**const**](classal_1_1_functor_v0_m.md) sead::SafeString & name) <br> |
...
```C++
virtual void al::EffectObj::control () 
```



Implements [*al::LiveActor::control*](classal_1_1_live_actor.md#function-control)
...
```C++
virtual const sead::Matrix34f * al::EffectObj::getBaseMtx () const
```



Implements [*al::LiveActor::getBaseMtx*](classal_1_1_live_actor.md#function-getbasemtx)
...
```C++
virtual void al::EffectObj::init (
...
```C++
virtual void al::EffectObj::kill () 
```



Implements [*al::LiveActor::kill*](classal_1_1_live_actor.md#function-kill)
...
```C++
virtual void al::EffectObj::makeActorAppeared () 
```



Implements [*al::LiveActor::makeActorAppeared*](classal_1_1_live_actor.md#function-makeactorappeared)
