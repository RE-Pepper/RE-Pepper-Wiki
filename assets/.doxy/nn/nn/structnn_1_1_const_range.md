...
# Struct nn::ConstRange

**template &lt;[**Result::Level**](classnn_1_1_result.md#enum-level) TLevel, [**Result::Summary**](classnn_1_1_result.md#enum-summary) TSummary, [**Result::Module**](classnn_1_1_result.md#enum-module) TModule, int TDescription, int A, int B&gt;**



[**ClassList**](annotated.md) **>** [**nn**](namespacenn.md) **>** [**ConstRange**](structnn_1_1_const_range.md)
...
| Type | Name |
| ---: | :--- |
|   | [**ConstRange**](#function-constrange) () <br> |
...
| Type | Name |
| ---: | :--- |
|  bool | [**Includes**](#function-includes) ([**Result**](classnn_1_1_result.md) result) <br> |
...
```C++
inline nn::ConstRange::ConstRange () 
```
...
```C++
static inline bool nn::ConstRange::Includes (
    Result result
) 
```
...
```C++
inline bool nn::ConstRange::operator<= (
    Result lhs,
    ConstRange
) 
```
