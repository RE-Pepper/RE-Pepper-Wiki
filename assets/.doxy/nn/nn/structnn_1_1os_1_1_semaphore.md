...
# Struct nn::os::Semaphore



[**ClassList**](annotated.md) **>** [**nn**](namespacenn.md) **>** [**os**](namespacenn_1_1os.md) **>** [**Semaphore**](structnn_1_1os_1_1_semaphore.md)
...
|   | [**Semaphore**](#function-semaphore) () <br> |
|   | [**~Semaphore**](#function-semaphore) () <br> |
...
```C++
inline void nn::os::Semaphore::Acquire () 
```
...
```C++
inline nn::os::Semaphore::Semaphore () 
```
...
------------------------------
The documentation for this class was generated from the following file `lib/CtrSDK/include/nn/os/os_Semaphore.h`
